...
const LoginSignup = () => {
  ...
  return (
    <div className="min-h-screen bg-[#feeeee] flex flex-col items-center justify-center px-4">
        ...
        {isLogin ? (
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div 
              ...
              className="text-left text-sm mt-2 text-[#B83232] cursor-pointer hover:underline">
              Forgot Password
            </div>
          </form>
        ) : (
